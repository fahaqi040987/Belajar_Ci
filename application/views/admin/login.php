                    ...
                    <div class="col-md-6">
                     ...
                     <a href="index.html" class="btn btn-social btn-facebook">
                        ...
                        <a href="index.html" class="btn btn-social btn-google">
                            ...
                            <br />
                            <!-- panggil eror dari controller dengan menggunakan set_flashdata -->
                            <?php if(!empty($this->session->flashdata('login_failed'))) { ?>
                                <div class="alert alert-warning">
                                    <button type="button" class="close" data-dismiss="alert" aria-hidden="true">&times;</button>
                                    <strong>Upss !!</strong>   <?php echo $this->session->flashdata('login_failed'); ?>
                                </div>
                            <?php } ?>
                            <form action="<?php echo base_url('admin/login/prosesLogin'); ?>" method="post">
